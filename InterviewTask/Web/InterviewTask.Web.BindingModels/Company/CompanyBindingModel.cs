namespace InterviewTask.Web.BindingModels.Company
{
    ...
    public class CompanyBindingModel : IMapTo<CompanyServiceModel>, IMapFrom<CompanyServiceModel>
    {
        ...
        [Required(ErrorMessage = StaticTextConstants.ADDRESS_ERROR_MESSAGE)]
